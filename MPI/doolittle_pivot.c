...
//       U[k][j] = *A - (L[k][0]*U[0][j] + ... + L[k][k-1]*U[k-1][j])    //
//                                 for j = k, k+1, ... , n-1                  //
//       L[i][k] = (*A - (L[i][0]*U[0][k] + . + L[i][k-1]*U[k-1][k]))    //
//                          / U[k][k]                                         //
//                                 for i = k+1, ... , n-1.                    //
...
//     err = Doolittle_LU_Decomposition_with_Pivoting(&*A, pivot, N);    //
...
//     else {            
//          printf ("run2\n");                                                     //
//        err = Doolittle_LU_with_Pivoting_Solve(A, B, pivot, x, N);   //
//        if (err < 0) printf(" Matrix A is singular\n");                     //
